...
$(document).on('knack-page-render.any', function (page, records, view, data) {
    ...
    dropDownToUrlMap.set('LISNDA Group Docs', 'https://drive.google.com/drive/folders/1HeLwhf4XbfAQu5z3cnXfoVtDbstbWT0z');
    dropDownToUrlMap.set('LISNDA Recipe Sharing Folder', 'https://drive.google.com/drive/folders/14Qs0wdZs_AgqRn1oryT1pEOuvXXJq352');
